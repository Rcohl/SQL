...
SELECT * FROM project WHERE description NOT LIKE '%Dolores%' OR start_date >= '2021-01-01';
-- Exo 3.5
-- Listez les projects :
-- - dont la description ne contient pas la chaîne de caractères `Dolores`
-- - ET dont la date de début est postérieure au 1er juillet 2021 inclus
SELECT * FROM project WHERE description NOT LIKE '%Dolores%' AND start_date >= '2021-01-01';
-- Exo 3.6
-- Listez les projects :
...
SELECT * FROM project WHERE start_date >= '2021-01-01' AND start_date <= '2021-07-01';
-- Exo 3.7
-- Listez les students :
