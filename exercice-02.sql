...
VALUES (NULL, 'Promo 2023', "La promo de l\'année 2023", '2023-03-15', NULL)
-- Exo 2.3'
...
SELECT id FROM tag WHERE name = 'SASS'; -- pour retrouver l'id de SASS
...
SELECT id FROM tag WHERE name = 'bash'; --pour retrouver l'id de Bash
UPDATE tag
...
-- - tag : Terminal Bash
SELECT id FROM student WHERE firstname = 'Zacharie' AND lastname = 'Evrard' --id = 100
SELECT id FROM tag WHERE name = 'Terminal Bash'; -- id = 10
...
SELECT id FROM project WHERE name = 'Dicta quia at qui.' -- l'id est 6
SELECT id FROM student WHERE firstname = 'Arthur' AND lastname = 'Lacombe'; -- l'id est 16
...
SELECT id FROM student WHERE firstname = 'Odette' AND lastname = 'Thomas' -- l'id est 99
